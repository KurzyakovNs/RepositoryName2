...
class Table:
    def __init__(self, width: Union[int, float], length: Union[int, float]): # Класс "Стол" с 2 характеристиками - высота и ширина
        """
...
class Mouse:
    def __init__(self, price: Union[int, float], weight: Union[int, float]): # Класс "Мышь" c 2 характеристиками - цена и вес
        """
